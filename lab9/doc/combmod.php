...
<p>
<p>Assume that <span class="emph">0 ≤ K ≤ N < P ≤ 10<sup>9</sup></span>
...
<p><span class="question">Question 1</span>
  ...
  <span class="emph">C(<span id="N">16</span>,
    <span id="K">15</span>) modulo
    <span id="P">29</span></span>?
</p>

<form action="/pl2/2019b/exercises/combmod.php" id="f" name="f" method="post">
